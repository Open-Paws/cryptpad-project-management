...
Default.commonCSP = function (Env) {
    ...
    return [
        `default-src 'none'`,
        // Open Paws brand typography loaded from Google Fonts CDN
        `style-src 'unsafe-inline' 'self' ${domain} https://fonts.googleapis.com`,
        `font-src 'self' data: ${domain} https://fonts.gstatic.com`,
